...
namespace Eticaret.WebUI.Areas.Admin.Controllers
{
    ...
    public class BrandsController : Controller
    {
        ...
        public async Task<IActionResult> Create(  Brand brand,IFormFile? Logo)//viewvdeki kontrolun adı logo ise burda da logo olmalı ***
        {

            if (ModelState.IsValid)
            {
                brand.Logo = await FileHelper.FileLoaderAysnc(Logo, "/Img/Brands/");
